...
app_ui = ui.page_fluid(
    ...
    ui.layout_sidebar(
        ...
        ui.input_select("person_home_ownership", "Estado de propiedad", {0: "MORTGAGE", 1: "RENT", 2: "OWN", 3:"OTHER"}),
        ui.input_numeric("person_emp_length", "Tiempo como empleado (años)", 9.0),
        ui.input_select("loan_intent", "Objetivo del préstamo", {0: "MEDICINAL", 1: "DEBTCONSOLIDATION", 2: "PERSONAL", 3: "VENTURE", 4: "HOMEIMPROVEMENT", 5: "EDUCATIONAL"}),
        ...
        ui.input_slider("loan_percent_income", "Porcentaje de ingreso (0.07 = 7%)", value=0.07, min=0, max=1, step=0.1),
        ui.input_select("cb_person_default_on_file", "¿Ha hecho default en alguno de sus préstamos?", {0: "N", 1: "Y"}),
...
def server(input, output, session):
    ...
    def _():
        ...
        testDataframe = pd.DataFrame([[input.person_income(), input.person_home_ownership(), input.person_emp_length(),
                                       input.loan_intent(), input.loan_grade(), input.loan_amnt(), input.loan_int_rate(),
